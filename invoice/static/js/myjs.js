$(document).ready(function () {
  ...
  $("#more-line").click(function () {
    ...
    $(
      "#div_id_line_six, #div_id_line_six_quantity, #div_id_line_six_unit_price, #div_id_line_six_total_price"
    ).slideToggle(200);
    $(
      "#div_id_line_seven, #div_id_line_seven_quantity, #div_id_line_seven_unit_price, #div_id_line_seven_total_price"
    ).slideToggle(200);
    $(
      "#div_id_line_eight, #div_id_line_eight_quantity, #div_id_line_eight_unit_price, #div_id_line_eight_total_price"
    ).slideToggle(200);
    $(
      "#div_id_line_nine, #div_id_line_nine_quantity, #div_id_line_nine_unit_price, #div_id_line_nine_total_price"
    ).slideToggle(200);
    $(
      "#div_id_line_ten, #div_id_line_ten_quantity, #div_id_line_ten_unit_price, #div_id_line_ten_total_price"
    ).slideToggle(200);
  ...
  $(
    ...
    var line_three_total =
      line_three_quantity_text * line_three_unit_price_text;
    ...
    var line_seven_total =
      line_seven_quantity_text * line_seven_unit_price_text;

    var line_eight_quantity_text = $("#id_line_eight_quantity").val();
    var line_eight_unit_price_text = $("#id_line_eight_unit_price").val();
    var line_eight_total =
      line_eight_quantity_text * line_eight_unit_price_text;
