from invoice_management.settings import PDF_ROOT
...
def home(request):
    # title ='wellcome to Invoice Managment app'
    context = {'context': 'Wellcome to Invoice Management app'}
    ...
    if request.method == 'POST':
        ...
        if form['generate_invoice'].value():
            ...
            def generate_invoice(name, invoice_number,
                ...
                c = canvas.Canvas(PDF_ROOT+pdf_file_name)

                # image of seal
                logo = 'Capture.png'
                c.drawImage(logo, 250, 730, width=100, height=30)
                ...
                c.drawCentredString(484, 620, 'INR' + "  " + total)
                ...
                c.setFont('Helvetica', 12, leading=None)
                c.drawCentredString(92, 640, "Phone : ")
                c.setFont('Helvetica', 12, leading=None)
                c.drawCentredString(170, 640, str('+91')+' '+phone_number)
                ...
                c.setFont('Helvetica-Bold', 20, leading=None)
                c.drawCentredString(493, 140, 'INR' + ' ' + total)
