...
class Invoice(models.Model):
    ...
    line_six = models.CharField('Item 6', max_length=120, default='', blank=True, null=True)
    ...
    line_seven = models.CharField('Item 7', max_length=120, default='', blank=True, null=True)
    ...
    line_eight = models.CharField('Item 8', max_length=120, default='', blank=True, null=True)
    ...
    line_nine = models.CharField('Item 9', max_length=120, default='', blank=True, null=True)
    ...
    line_ten = models.CharField('Item 10', max_length=120, default='', blank=True, null=True)
